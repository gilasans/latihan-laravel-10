                      ...
                      <form>
                        <div class="card-body">
                          ...
                          <div class="form-group">
                            <label for="exampleInputEmail1">fhoto profile </label>
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" name="nama" class="form-control" value="{{old('nama')}}" id="exampleInputEmail1" placeholder="Enter name">
                              @error('nama')
                                <small>{{$message}}</small>
                            @enderror
                            </div>
